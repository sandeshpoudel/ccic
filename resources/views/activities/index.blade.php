                            ...
                            <div class="widget-box  transparent collapsed">
                                ...
                                <div class="widget-header widget-header-small ">
                                    ...
                                    <h5 class="widget-title smaller">
                                        ...
                                        <b>{{ App\User::find($activity->causer_id)->name }}</b></a>
                                        <span class="grey">{{ $activity->description }} {{ $activity->log_name }}</span> number {{ $activity->subject_id }}, {{ $activity->created_at->diffForHumans() }}
