...
@section('title')
    Update Member's Event Representative
@stop
...
{{--    {!! Form::model(['url' => 'staff/representatives/', 'class' => 'form-horizontal']) !!}--}}
    {!! Form::model($representative, ['method' => 'patch','url' => 'staff/representatives/'.$representative->id, 'class' => 'form-horizontal']) !!}
    {{--input for name--}}
