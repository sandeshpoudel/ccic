...
<div class="form-group">
    {{ Form::label('parent_id', 'Parent Category:', ['class' => 'col-sm-3 control-label no-padding-right']) }}
    <div class="col-sm-9">
        {{--{!! Form::text('type',null, ['class' => 'col-xs-10 col-sm-5', 'id'=>'form-field-icon-2']) !!}--}}
        {!! Form::select('parent_id', $categories, null, ['placeholder' => 'Root Category', 'class' => 'chosen-select']) !!}
