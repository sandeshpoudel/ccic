                ...
                <ul class="list-unstyled  spaced">
                    ...
                    <li>
                        <div class="form-group {{ $errors->has('duedate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {!! Form::text('duedate',$fiscal->durationFromBs, ['class' => 'col-xs-10 col-sm-10 date-picker']) !!}
                                <i class="ace-icon fa fa-asterisk bigger-110 red"></i>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="form-group {{ $errors->has('date') ? ' has-error' : '' }}">
                            {{ Form::label('date', 'Date:', ['class' => 'col-sm-3 control-label no-padding-right']) }}
                            <div class="col-sm-9">
                                {!! Form::text('date',null, ['class' => 'col-xs-10 col-sm-10 date-picker', 'id'=>'nepaliDateFrom' ]) !!}
                                <i class="ace-icon fa fa-asterisk bigger-110 red"></i>
                            </div>
                        </div>
                    </li>
            ...
            <tr>
                ...
                <td class="hidden-xs">
                    <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-12">
                            {!! Form::textarea('invoiceitem[description][]','New member registration', ['class' => 'col-xs-11 col-sm-11', 'id'=>'form-field-icon-2', 'rows' => '2']) !!}
                            <i class="ace-icon fa fa-asterisk bigger-110 red"></i>
                        </div>
                ...
                <td>
                    <div class="form-group {{ $errors->has('amount') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-12">
                            {!! Form::text('invoiceitem[amount][]',$fee->entry, ['class' => 'col-xs-11 col-sm-11', 'id'=>'form-field-icon-2']) !!}
                            <i class="ace-icon fa fa-asterisk bigger-110 red"></i>
                        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group {{ $errors->has('paidamount') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('paidamount',$fee->entry, ['class' => 'col-xs-10 col-sm-10', 'id'=>'form-field-icon-2']) !!}
                            <i class="ace-icon fa fa-asterisk bigger-110 red"></i>
                        </div>
